...
function translate(lang){
	...
	if(lang === "jp"){
		...
		$(".gallery").find("li").eq(8).find(".galleryText").html("一次創作シリーズの主要キャラクター6人");
		$(".gallery").find("li").eq(9).find(".galleryText").html("春秋会１００周年<br>ロゴマーク");
		$(".gallery").find("li").eq(10).find(".galleryText").html("プリントパック<br>年賀状2024辰年");
		$(".gallery").find("li").eq(11).find(".galleryText").html("WeChooseLocal店舗ページ<br>ヒーローバナーシリーズ");
		$(".gallery").find("li").eq(12).find(".galleryText").html("PUGOのカバー画像");
		$(".gallery").find("li").eq(13).find(".galleryText").html("PebblePathの段差付き<br>フォルダーインサート");
		$(".gallery").find("li").eq(14).find(".galleryText").html("Stonebridge Dental と PebblePathの<br>夏季キャンペーン用フライヤ");
		$(".gallery").find("li").eq(15).find(".galleryText").html("AtriumXの名刺");
		$(".gallery").find("li").eq(16).find(".galleryText").html("AtriumXの会場マップ");
		$(".gallery").find("li").eq(17).find(".galleryText").html("405 Dental Aesthetics のアメニティ<br>紹介用ラックカード");
		$(".gallery").find("li").eq(18).find(".galleryText").html("Root Dental プレゼン資料");
		$(".gallery").find("li").eq(19).find(".galleryText").html("Katy Smile Designのクーポン");
		$(".gallery").find("li").eq(20).find(".galleryText").html("Fred’s Pharmacyのハーフページ広告");
		...
		$("#galleryModal21").find("h2").text("一次創作シリーズの主要キャラクター6人");
		...
		$("#galleryModal21").find("p").html("未発表の一次創作シリーズから、中心となる6人を初めて公開した作品です。物語の予告として色は抑え、光る目とキーカラーだけを見せながら、ポーズ、表情、体格、衣装を完成させています。");
		...
		$(".gallery").find("li").eq(8).find(".galleryText").html("Original Character Lineup from My Series");
		$(".gallery").find("li").eq(9).find(".galleryText").html("Shunjukai 100th Anniversary Logo");
		$(".gallery").find("li").eq(10).find(".galleryText").html("Printpac New Year's Card<br>Year of the Dragon 2024");
		$(".gallery").find("li").eq(11).find(".galleryText").html("WeChooseLocal Website Hero Banners");
		$(".gallery").find("li").eq(12).find(".galleryText").html("PUGO Cover Photo");
		$(".gallery").find("li").eq(13).find(".galleryText").html("PebblePath Staggered Folder Inserts");
		$(".gallery").find("li").eq(14).find(".galleryText").html("Stonebridge Pebble Path Summer Flyers");
		$(".gallery").find("li").eq(15).find(".galleryText").html("AtriumX Business Card");
		$(".gallery").find("li").eq(16).find(".galleryText").html("AtriumX Conference Maps");
		$(".gallery").find("li").eq(17).find(".galleryText").html("405 Dental Aesthetics Amenities Menu");
		$(".gallery").find("li").eq(18).find(".galleryText").html("Root Dental PowerPoint Deck");
		$(".gallery").find("li").eq(19).find(".galleryText").html("Katy Smile Design Swim Coupons");
		$(".gallery").find("li").eq(20).find(".galleryText").html("Freds Pharmacy Half-Page Newspaper Ad");
		...
		$("#galleryModal21").find("h2").text("Original Character Lineup from My Series");
		...
		$("#galleryModal21").find("p").html("A first public look at the six central characters from my unpublished original series. Their mostly uncolored designs act as a teaser, revealing only their glowing eyes and key colors while keeping their poses, expressions, anatomy, and outfits fully established.");
